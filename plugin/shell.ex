	...
	<div ng-class="{'scroll': page=='about'}" class="aboutOuter">
		<div class="about">
			<div abouts="abouts" ng-class="{'hide': page!='about'}" class="aboutInner">
				...
				<div class="social desktop"><a href="mailto:{{Mailto}}" target="blank"><i class="i i-envelope"><h2>email </h2></i></a><a href="https://www.facebook.com/search/pages/?q={{Socials}}" target="blank"><i class="i i-facebook"><h2>facebook </h2></i></a><a href="https://instagram.com/{{Socials}}" target="blank"><i class="i i-instagram"><h2>instagram </h2></i></a><a instagram="instagram" href="!" ng-click="Instagram()"><i class="i i-About"><h2>instagram </h2></i></a>
				</div>
			</div>
		</div>
	</div>
