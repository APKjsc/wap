	...
	<div ng-class="{'scroll': page=='about'}" class="aboutOuter">
		<div class="about">
			<div abouts="abouts" ng-class="{'hide': page!='about'}" class="aboutInner">
				...
				<div class="social desktop"><a href="mailto:{{Mailto}}" target="blank"><i class="i i-envelope"><h2>email </h2></i></a><a href="https://www.facebook.com/{{Socials}}" target="blank"><i class="i i-facebook"><h2>facebook </h2></i></a><a href="https://twitter.com/{{Socials}}" target="blank"><i class="i i-twitter"><h2>twitter </h2></i></a><a instagram="instagram" href="!" ng-click="Instagram()"><i class="i i-Instagram"><h2>instagram </h2></i></a>
				</div>
			</div>
		</div>
	</div>
